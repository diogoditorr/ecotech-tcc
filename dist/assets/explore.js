var d=Object.defineProperty;var l=(s,t,e)=>t in s?d(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var o=(s,t,e)=>(l(s,typeof t!="symbol"?t+"":t,e),e);import{F as p}from"./favorite-button.66709062.js";class r extends p{constructor(t,e,i,n){super(e,i,n);o(this,"part");this.part=t}toggleFavorite(){this.disableButton(),this.part.favoriteButton!==this&&this.part.favoriteButton.disableButton(),fetch("../../src/php/favorite-part.php",{method:"POST",headers:{"Content-Type":"application/json;charset=utf-8"},body:JSON.stringify({partId:this.part.id})}).then(t=>{setTimeout(()=>{if(t.status===200){const e=!this.isFavorited;this.setFavorite(e),this.part.favoriteButton!==this&&this.part.favoriteButton.setFavorite(e),this.enableButton(),this.part.favoriteButton!==this&&this.part.favoriteButton.enableButton(),this.updatePart(),this.updateButtonDataset(),this.part.favoriteButton!==this&&this.part.favoriteButton.updateButtonDataset(),this.updateText(),this.part.favoriteButton!==this&&this.part.favoriteButton.message!==void 0&&this.part.favoriteButton.updateText()}},1e3)}).catch(t=>{this.enableButton(),console.log(t)})}updatePart(){this.part.setFavorite(this.isFavorited)}}class a{constructor(t){o(this,"part");o(this,"page");o(this,"modal");o(this,"modalContent");o(this,"modalSkeletonTemplate");this.part=t,this.page=document.querySelector("#page-explore"),this.modal=document.querySelector("#modal"),this.modalContent=document.querySelector("#modal .content"),this.modalSkeletonTemplate=document.getElementById("modal-skeleton-template"),document.querySelector("#modal .close").addEventListener("click",this.closeModal.bind(this))}static create(t){const e=new a(t);e.openModal(),e.loadData()}openModal(){this.modal.classList.remove("hide"),this.page.classList.add("blur")}closeModal(){this.modal.classList.add("hide"),this.page.classList.remove("blur"),this.modalContent.innerHTML=""}loadData(){this.modalContent.innerHTML=this.modalSkeletonTemplate.innerHTML,fetch("../../src/php/get-part-details.php",{method:"POST",headers:{"Content-Type":"application/json;charset=utf-8"},body:JSON.stringify({partId:this.part.id})}).then(t=>t.json()).then(t=>{const e="../../storage/parts/";console.log(t),this.modalContent.innerHTML=`
                ...
                `,new r(this.part,this.modalContent.querySelector(".left button.favorite"),this.part.isFavorited,{favorited:"Remover",notFavorited:"Tenho Interesse"})}).catch(t=>{console.log(t)})}}class h{constructor(t){o(this,"element");o(this,"id");o(this,"isFavorited");o(this,"favoriteButton");const e=t.querySelector(".see-details"),i=t.querySelector(".favorite");this.element=t,this.id=Number(t.getAttribute("data-id")),this.isFavorited=i.getAttribute("data-is-favorited")==="true",this.favoriteButton=new r(this,i,this.isFavorited),e.addEventListener("click",a.create.bind(null,this))}setFavorite(t){this.isFavorited=t}}const c=document.querySelectorAll("#page-explore .part");c.forEach(s=>{new h(s)});
